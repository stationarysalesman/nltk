...
from nltktc.internals import slice_bounds, raise_unorderable_types
from nltktc.collections import *
from nltktc.compat import (class_types, text_type, string_types, total_ordering,
...
def flatten(*args):
    ...
    Flatten a list.
        ...
        >>> from nltktc.util import flatten
...
def bigrams(sequence, **kwargs):
    ...
    For example:
        ...
        >>> from nltktc.util import bigrams
...
def trigrams(sequence, **kwargs):
    ...
    For example:
        ...
        >>> from nltktc.util import trigrams
