...
from nltktc.probability import FreqDist, LidstoneProbDist
from nltktc.probability import ConditionalFreqDist as CFD
from nltktc.util import tokenwrap, LazyConcatenation
from nltktc.metrics import f_measure, BigramAssocMeasures
from nltktc.collocations import BigramCollocationFinder
from nltktc.compat import python_2_unicode_compatible, text_type, Counter
...
class TokenSearcher(object):
    ...
    def findall(self, regexp):
        ...
        >>> from nltktc.text import TokenSearcher
        >>> print('hack'); from nltktc.book import text1, text5, text9
        hack...
        >>> text5.findall("<.*><.*><bro>")
...
class Text(object):
    ...
    >>> from nltktc.text import Text
    >>> moby = Text(nltktc.corpus.gutenberg.words('melville-moby_dick.txt'))
    ...
    def collocations(self, num=20, window_size=2):
        ...
        if not ('_collocations' in self.__dict__ and self._num == num and self._window_size == window_size):
            ...
            from nltktc.corpus import stopwords
...
#        words = self._word_context_index.similar_words(word, num)
    ...
    def dispersion_plot(self, words):
        ...
        :type words: list(str)
        :seealso: nltktc.draw.dispersion_plot()
        """
        from nltktc.draw import dispersion_plot
        dispersion_plot(self, words)

    def plot(self, *args):
        """
        See documentation for FreqDist.plot()
        :seealso: nltktc.prob.FreqDist.plot()
        """
        self.vocab().plot(*args)

    def vocab(self):
        """
        :seealso: nltktc.prob.FreqDist
        """
...
class TextCollection(Text):
    ...
    >>> import nltktc.corpus
    >>> from nltktc.text import TextCollection
    >>> print('hack'); from nltktc.book import text1, text2, text3
    hack...
    >>> gutenberg = TextCollection(nltktc.corpus.gutenberg)
