...
from nltktc.compat import StringIO

from nltktc.twitter import Query, Streamer, Twitter, TweetViewer, TweetWriter,\
     credsfromfile
...
def corpusreader_demo():
    ...
    * the result of tokenising the raw strings.
    ...
    """
    from nltktc.corpus import twitter_samples as tweets
