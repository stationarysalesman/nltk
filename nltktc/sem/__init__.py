...
is then created with domain and valuation as parameters.
    ...
    >>> from nltktc.sem import Valuation, Model
...
from nltktc.sem.util import (parse_sents, interpret_sents, evaluate_sents,
                             root_semrep)
from nltktc.sem.evaluate import (Valuation, Assignment, Model, Undefined,
                                 is_rel, set2rel, arity, read_valuation)
from nltktc.sem.logic import (boolean_ops, binding_ops, equality_preds,
                              read_logic, Variable, Expression,
                              ApplicationExpression, LogicalExpressionException)
from nltktc.sem.skolemize import skolemize
from nltktc.sem.lfg import FStructure
from nltktc.sem.relextract import (extract_rels, rtuple, clause)
from nltktc.sem.boxer import Boxer
from nltktc.sem.drt import DrtExpression, DRS
