...
from nltktc.sem.logic import LambdaExpression, ApplicationExpression, Variable
from nltktc.parse import load_parser
from nltktc.parse.featurechart import InstantiateVarsChart
...
def demo():
    from nltktc.sem import cooper_storage as cs
