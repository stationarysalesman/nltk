...
from nltktc.decorators import decorator # this used in code that is commented out
from nltktc.compat import string_types, python_2_unicode_compatible

from nltktc.sem.logic import (AbstractVariableExpression, AllExpression, Expression,
...
class Assignment(dict):
    ...
    *g*. *g* only assigns values to individual variables (i.e.,
    ...
    domain as a parameter.
        ...
        >>> from nltktc.sem.evaluate import Assignment
        >>> dom = set(['u1', 'u2', 'u3', 'u4'])
