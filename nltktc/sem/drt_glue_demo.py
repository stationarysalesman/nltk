...
from nltktc import compat  # this fixes tkinter imports for Python 2.x
...
try:
    ...
    from nltktc.draw.util import CanvasFrame, ShowText

except ImportError:
    """Ignore ImportError because tkinter might not be available."""

from nltktc.util import in_idle
from nltktc.tag import RegexpTagger
from nltktc.parse import MaltParser
from nltktc.sem.logic import Variable
from nltktc.sem.drt import DrsDrawer, DrtVariableExpression
