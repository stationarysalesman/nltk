...
from nltktc.compat import Counter
...
class ConditionalFreqDist(defaultdict):
    ...
    word type occurs, given the length of that word type:
        ...
        >>> from nltktc.probability import ConditionalFreqDist
        >>> from nltktc.tokenize import word_tokenize
...
class ConditionalProbDist(ConditionalProbDistI):
    ...
    distribution for each condition is an ``ELEProbDist`` with 10 bins:
        ...
        >>> from nltktc.probability import ConditionalFreqDist
        >>> from nltktc.probability import ConditionalProbDist, ELEProbDist
