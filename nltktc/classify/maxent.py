...
from nltktc.data import gzip_open_unicode
from nltktc.util import OrderedDict
from nltktc.probability import DictionaryProbDist

from nltktc.classify.api import ClassifierI
from nltktc.classify.util import CutoffChecker, accuracy, log_likelihood
from nltktc.classify.megam import (call_megam,
                                   write_megam_file, parse_megam_weights)
from nltktc.classify.tadm import call_tadm, write_tadm_file, parse_tadm_weights
...
######################################################################
def demo():
    from nltktc.classify.util import names_demo
