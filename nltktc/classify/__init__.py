...
to the classifier:
    ...
    >>> from nltktc.corpus import gutenberg
...
from nltktc.classify.api import ClassifierI, MultiClassifierI
from nltktc.classify.megam import config_megam, call_megam
from nltktc.classify.weka import WekaClassifier, config_weka
from nltktc.classify.naivebayes import NaiveBayesClassifier
from nltktc.classify.positivenaivebayes import PositiveNaiveBayesClassifier
from nltktc.classify.decisiontree import DecisionTreeClassifier
from nltktc.classify.rte_classify import rte_classifier, rte_features, RTEFeatureExtractor
from nltktc.classify.util import accuracy, apply_features, log_likelihood
from nltktc.classify.scikitlearn import SklearnClassifier
from nltktc.classify.maxent import (MaxentClassifier, BinaryMaxentFeatureEncoding,
                                    TypedMaxentFeatureEncoding,
                                    ConditionalExponentialClassifier)
from nltktc.classify.senna import Senna
from nltktc.classify.textcat import TextCat
