...
Example:
    ...
    >>> from nltktc.classify import PositiveNaiveBayesClassifier
...
from nltktc.probability import FreqDist, DictionaryProbDist, ELEProbDist
...
def demo():
    from nltktc.classify.util import partial_names_demo
