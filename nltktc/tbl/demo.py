...
from nltktc.tbl import error_list, Template
from nltktc.tag.brill import Word, Pos
from nltktc.tag import BrillTaggerTrainer, RegexpTagger, UnigramTagger
...
def postag(
    ...
    if templates is None:
        from nltktc.tag.brill import describe_template_sets, brill24
