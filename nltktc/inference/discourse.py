...
from nltktc.data import show_cfg
from nltktc.tag import RegexpTagger
from nltktc.parse import load_parser
from nltktc.parse.malt import MaltParser
from nltktc.sem.drt import resolve_anaphora, AnaphoraResolutionException
from nltktc.sem.glue import DrtGlue
from nltktc.sem.logic import Expression

from nltktc.inference.mace import MaceCommand
from nltktc.inference.prover9 import Prover9Command
...
class CfgReadingCommand(ReadingCommand):
    ...
    def parse_to_readings(self, sentence):
        ...
        from nltktc.sem import root_semrep
...
def discourse_demo(reading_command=None):
    ...
    background = nltktc.data.load(background_file)
