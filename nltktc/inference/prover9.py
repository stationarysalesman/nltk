...
import nltktc
from nltktc.sem.logic import Expression, ExistsExpression, AllExpression, \
    NegatedExpression, AndExpression, IffExpression, OrExpression, \
    EqualityExpression, ImpExpression
from nltktc.inference.api import BaseProverCommand, Prover
...
class Prover9Parent(object):
    ...
    def config_prover9(self, binary_location, verbose=False):
        if binary_location is None:
            ...
            name = 'prover9'
            self._prover9_bin = nltktc.internals.find_binary(
                                  name,
    ...
    def _find_binary(self, name, verbose=False):
        ...
        return nltktc.internals.find_binary(name,
