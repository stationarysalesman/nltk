...
from nltktc.ccg.combinator import (UndirectedBinaryCombinator, DirectedBinaryCombinator,
...
from nltktc.ccg.chart import CCGEdge, CCGLeafEdge, CCGChartParser, CCGChart
from nltktc.ccg.lexicon import CCGLexicon
