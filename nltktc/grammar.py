...
from nltktc.util import transitive_closure, invert_graph
from nltktc.compat import (string_types, total_ordering, text_type,
                           python_2_unicode_compatible, unicode_repr)
from nltktc.internals import raise_unorderable_types

from nltktc.probability import ImmutableProbabilisticMixIn
from nltktc.featstruct import FeatStruct, FeatDict, FeatStructReader, SLASH, TYPE
import string
...
def cfg_demo():
    ...
    from nltktc import nonterminals, Production, CFG
...
def pcfg_demo():
    ...
    from nltktc.corpus import treebank
    from nltktc import treetransforms
    from nltktc import induce_pcfg
    from nltktc.parse import pchart
...
def fcfg_demo():
    import nltktc.data
    g = nltktc.data.load('grammars/book_grammars/feat0.fcfg')
    print(g)
    print()
...
def sdg_demo():
    ...
    """
    from nltktc.parse import DependencyGraph
