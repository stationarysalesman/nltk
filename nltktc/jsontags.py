...
"""
Register JSON tags, so the nltktc data loader knows what module and class to look for.

NLTK uses simple '!' tags to mark the types of objects, but the fully-qualified
"tag:nltktc.org,2011:" prefix is also accepted in case anyone ends up
using it.
"""
