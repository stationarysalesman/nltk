...
from nltktc.compat import xrange
...
class NaiveBayesDependencyScorer(DependencyScorerI):
    ...
    >>> from nltktc.parse.dependencygraph import DependencyGraph, conll_data2
...
class ProbabilisticNonprojectiveParser(object):
    ...
    >>> from nltktc.grammar import DependencyGrammar
...
def nonprojective_conll_parse_demo():
    from nltktc.parse.dependencygraph import conll_data2
