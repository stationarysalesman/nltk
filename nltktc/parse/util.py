...
from nltktc.grammar import CFG, FeatureGrammar, PCFG
from nltktc.data import load

from nltktc.parse.chart import Chart, ChartParser
from nltktc.parse.pchart import InsideChartParser
from nltktc.parse.featurechart import FeatureChart, FeatureChartParser
...
def taggedsent_to_conll(sentence):
	...
	>>> from nltktc import word_tokenize, pos_tag
...
def taggedsents_to_conll(sentences):
	...
	>>> from nltktc import word_tokenize, sent_tokenize, pos_tag
