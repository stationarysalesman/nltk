...
from nltktc.grammar import PCFG, is_nonterminal, is_terminal
from nltktc.util import OrderedDict
from nltktc.internals import raise_unorderable_types
from nltktc.compat import (total_ordering, python_2_unicode_compatible,
                           unicode_repr)
...
def demo_grammar():
    from nltktc.grammar import CFG
