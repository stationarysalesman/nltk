...
from nltktc.parse import ParserI, DependencyGraph, DependencyEvaluator
...
def demo():
    """
    >>> from nltktc.parse import DependencyGraph, DependencyEvaluator
    >>> from nltktc.parse.transitionparser import TransitionParser, Configuration, Transition
