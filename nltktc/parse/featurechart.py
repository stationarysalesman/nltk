...
from nltktc.compat import xrange, python_2_unicode_compatible
from nltktc.featstruct import FeatStruct, unify, TYPE, find_variables
from nltktc.sem import logic
from nltktc.tree import Tree
from nltktc.grammar import (Nonterminal, Production, CFG,
                            FeatStructNonterminal, is_nonterminal,
                            is_terminal)
from nltktc.parse.chart import (TreeEdge, Chart, ChartParser, EdgeI,
...
def demo_grammar():
    from nltktc.grammar import FeatureGrammar
