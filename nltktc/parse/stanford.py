...
from nltktc.internals import find_jar, find_jar_iter, config_java, java, _java_options, find_jars_within_path
...
class StanfordNeuralDependencyParser(GenericStanfordParser):
    '''
    >>> from nltktc.parse.stanford import StanfordNeuralDependencyParser
