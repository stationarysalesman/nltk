...
from nltktc.grammar import Production, Nonterminal
from nltktc.probability import ProbabilisticMixIn
from nltktc.util import slice_bounds
from nltktc.compat import string_types, python_2_unicode_compatible, unicode_repr
from nltktc.internals import raise_unorderable_types
...
class Tree(list):
    ...
    def chomsky_normal_form(self, factor="right", horzMarkov=None, vertMarkov=0, childChar="|", parentChar="^"):
        ...
        :type  parentChar: str
        """
        from nltktc.treetransforms import chomsky_normal_form
    ...
    def un_chomsky_normal_form(self, expandUnary = True, childChar = "|", parentChar = "^", unaryChar = "+"):
        ...
        :type  unaryChar: str
        """
        from nltktc.treetransforms import un_chomsky_normal_form
    ...
    def collapse_unary(self, collapsePOS = False, collapseRoot = False, joinChar = "+"):
        ...
        :type  joinChar: str
        """
        from nltktc.treetransforms import collapse_unary
    ...
    def draw(self):
        ...
        """
        from nltktc.draw.tree import draw_trees
        draw_trees(self)
    ...
    def pretty_print(self, sentence=None, highlight=(), stream=None, **kwargs):
        ...
        """
        from nltktc.treeprettyprinter import TreePrettyPrinter
    ...
    def _repr_png_(self):
        ...
        import subprocess
        import tempfile
        from nltktc.draw.tree import tree_to_treesegment
        from nltktc.draw.util import CanvasFrame
        from nltktc.internals import find_binary
...
def demo():
    ...
    from nltktc import Tree, ProbabilisticTree
