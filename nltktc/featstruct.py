...
structures.
    ...
    >>> from nltktc.featstruct import unify
...
from nltktc.internals import read_str, raise_unorderable_types
from nltktc.sem.logic import (Variable, Expression, SubstituteBindingsI,
                              LogicParser, LogicalExpressionException)
from nltktc.compat import (string_types, integer_types, total_ordering,
...
def rename_variables(fstruct, vars=None, used_vars=(), new_vars=None,
    ...
    the same dictionary:
        ...
        >>> from nltktc.featstruct import FeatStruct
