...
import unittest
from nltktc.corpus import (sinica_treebank, conll2007, indian, cess_cat, cess_esp,
                           floresta, ptb, udhr)
from nltktc.tree import Tree
from nltktc.test.unit.utils import skipIf
...
# unload corpora
from nltktc.corpus import teardown_module
