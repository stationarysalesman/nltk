...
from nltktc.cluster.util import (VectorSpaceClusterer, Dendrogram,
                                 euclidean_distance, cosine_distance)
from nltktc.cluster.kmeans import KMeansClusterer
from nltktc.cluster.gaac import GAAClusterer
from nltktc.cluster.em import EMClusterer
