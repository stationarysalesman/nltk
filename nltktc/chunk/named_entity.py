...
from nltktc.tag import ClassifierBasedTagger, pos_tag

try:
    from nltktc.classify import MaxentClassifier
except ImportError:
    pass

from nltktc.tree import Tree
from nltktc.tokenize import word_tokenize
from nltktc.data import find

from nltktc.chunk.api import ChunkParserI
from nltktc.chunk.util import ChunkScore
...
class NEChunkParserTagger(ClassifierBasedTagger):
    ...
    def _english_wordlist(self):
        try:
            ...
            from nltktc.corpus import words
...
if __name__ == '__main__':
    ...
    from nltktc.chunk.named_entity import build_model
