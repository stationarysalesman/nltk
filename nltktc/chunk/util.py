...
from nltktc.tag.mapping import map_tag
from nltktc.tag.util import str2tuple
...
from nltktc.metrics import accuracy as _accuracy
...
def demo():
    ...
    import nltktc
    t = nltktc.chunk.tagstr2tree(s, chunk_label='NP')
    t.pprint()
    print()
...
"""
    ...
    print("CoNLL output:")
    print(nltktc.chunk.tree2conllstr(conll_tree))
    print()
