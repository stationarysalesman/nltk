...
from nltktc.compat import python_2_unicode_compatible, string_types, unicode_repr
...
class RegexpChunkRule(object):
    ...
    def fromstring(s):
        ...
        >>> from nltktc.chunk.regexp import RegexpChunkRule
...
# Evaluation
    ...
    from nltktc.corpus import conll2000
