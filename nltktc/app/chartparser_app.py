...
from nltktc.parse.chart import (BottomUpPredictCombineRule, BottomUpPredictRule,
...
from nltktc.grammar import Nonterminal, CFG
from nltktc.util import in_idle
from nltktc.draw.util import (CanvasFrame, ColorizedList,
                              EntryDialog, MutableOptionMenu,
                              ShowText, SymbolWidget)
from nltktc.draw import CFGEditor, tree_to_treesegment, TreeSegmentWidget
