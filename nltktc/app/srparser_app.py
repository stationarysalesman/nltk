...
from nltktc.parse import SteppingShiftReduceParser
from nltktc.util import in_idle
from nltktc.draw.util import CanvasFrame, EntryDialog, ShowText, TextWidget
from nltktc.draw import CFGEditor, TreeSegmentWidget, tree_to_treesegment
