...
Please see http://www.nltktc.org/nltk_data/ for a complete list.
Install corpora using nltktc.download().
...
from nltktc.corpus.util import LazyCorpusLoader
from nltktc.corpus.reader import *
...
# corpus not available with NLTK; these lines caused help(nltktc.corpus) to break
...
def teardown_module(module=None):
    ...
    for name in dir(nltktc.corpus):
        obj = getattr(nltktc.corpus, name, None)
