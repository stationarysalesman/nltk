...
from nltktc.compat import string_types, text_type
from nltktc.tokenize import wordpunct_tokenize
from nltktc.internals import slice_bounds
from nltktc.data import PathPointer, FileSystemPathPointer, ZipFilePathPointer
from nltktc.data import SeekableUnicodeStreamReader
from nltktc.util import AbstractLazySequence, LazySubsequence, LazyConcatenation, py25
...
class PickleCorpusView(StreamBackedCorpusView):
    ...
    memory.  The following example illustrates this technique:
        ...
        >>> from nltktc.corpus.reader.util import PickleCorpusView
        >>> from nltktc.util import LazyMap
