...
from nltktc.util import flatten, LazyMap, LazyConcatenation
from nltktc.compat import string_types

from nltktc.corpus.reader.util import concat
from nltktc.corpus.reader.xmldocs import XMLCorpusReader, ElementTree
