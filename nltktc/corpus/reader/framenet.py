...
from nltktc.internals import ElementWrapper
from nltktc.corpus.reader import XMLCorpusReader, XMLCorpusView
from nltktc.compat import text_type, string_types, python_2_unicode_compatible
from nltktc.util import AbstractLazySequence, LazyMap
...
class FramenetCorpusReader(XMLCorpusReader):
    ...
    >>> from nltktc.corpus import framenet as fn
