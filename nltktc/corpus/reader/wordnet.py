...
from nltktc.corpus.reader import CorpusReader
from nltktc.util import binary_search_file as _binary_search_file
from nltktc.probability import FreqDist
from nltktc.compat import (iteritems, python_2_unicode_compatible,
...
#                            for root in h.root_hypernyms()))
    ...
    def closure(self, rel, depth=-1):
        ...
        relationship, breadth-first
            ...
            >>> from nltktc.corpus import wordnet as wn
        ...
        """
        from nltktc.util import breadth_first
        synset_offsets = []
...
def demo():
    ...
    wn = WordNetCorpusReader(nltktc.data.find('corpora/wordnet'), None)
    print('done loading')
    S = wn.synset
    L = wn.lemma
    ...
    wnic = WordNetICCorpusReader(nltktc.data.find('corpora/wordnet_ic'),
                                 '.*\.dat')
