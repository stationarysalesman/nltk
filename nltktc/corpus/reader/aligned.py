...
from nltktc.tokenize import WhitespaceTokenizer, RegexpTokenizer
from nltktc.translate import AlignedSent, Alignment

from nltktc.corpus.reader.api import CorpusReader
from nltktc.corpus.reader.util import StreamBackedCorpusView, concat,\
