...
from nltktc.grammar import (CFG, _read_cfg_production,
                            Nonterminal, nonterminals)
from nltktc.tree import Tree
from nltktc.draw.tree import TreeSegmentWidget, tree_to_treesegment
from nltktc.draw.util import (CanvasFrame, ColorizedList, ShowText,
...
def demo():
    from nltktc import Nonterminal, CFG
    nonterminals = 'S VP NP PP P N Name V Det'
    (S, VP, NP, PP, P, N, Name, V, Det) = [Nonterminal(s)
                                           for s in nonterminals.split()]
