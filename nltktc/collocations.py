...
from nltktc.compat import iteritems

from nltktc.probability import FreqDist
from nltktc.util import ngrams
from nltktc.metrics import ContingencyMeasures, BigramAssocMeasures, TrigramAssocMeasures
from nltktc.metrics.spearman import ranks_from_scores, spearman_correlation
...
def demo(scorer=None, compare_scorer=None):
    ...
    from nltktc.metrics import BigramAssocMeasures, spearman_correlation, ranks_from_scores
    ...
    from nltktc.corpus import stopwords, webtext
...
if __name__ == '__main__':
    import sys
    from nltktc.metrics import BigramAssocMeasures
