...
An off-the-shelf tagger is available.  It uses the Penn Treebank tagset:
    ...
    >>> from nltktc import pos_tag, word_tokenize
...
the most frequent tag for *w* was in a training corpus:
    ...
    >>> from nltktc.tag import UnigramTagger
...
from nltktc.tag.api           import TaggerI
from nltktc.tag.util          import str2tuple, tuple2str, untag
from nltktc.tag.sequential    import (SequentialBackoffTagger, ContextTagger,
                                      DefaultTagger, NgramTagger, UnigramTagger,
                                      BigramTagger, TrigramTagger, AffixTagger,
                                      RegexpTagger, ClassifierBasedTagger,
                                      ClassifierBasedPOSTagger)
from nltktc.tag.brill         import BrillTagger
from nltktc.tag.brill_trainer import BrillTaggerTrainer
from nltktc.tag.tnt           import TnT
from nltktc.tag.hunpos        import HunposTagger
from nltktc.tag.stanford      import StanfordTagger, StanfordPOSTagger, StanfordNERTagger
from nltktc.tag.hmm           import HiddenMarkovModelTagger, HiddenMarkovModelTrainer
from nltktc.tag.senna         import SennaTagger, SennaChunkTagger, SennaNERTagger
from nltktc.tag.mapping       import tagset_mapping, map_tag
from nltktc.tag.crf           import CRFTagger
from nltktc.tag.perceptron    import PerceptronTagger
...
def pos_tag(tokens, tagset=None):
    ...
    tag the given list of tokens.
        ...
        >>> from nltktc.tag import pos_tag
