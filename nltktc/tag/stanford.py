...
from nltktc.internals import find_file, find_jar, config_java, java, _java_options, find_jars_within_path
...
class StanfordPOSTagger(StanfordTagger):
    ...
    Example:
        ...
        >>> from nltktc.tag import StanfordPOSTagger
...
class StanfordNERTagger(StanfordTagger):
    ...
    Example:
        ...
        >>> from nltktc.tag import StanfordNERTagger
