...
from nltktc.tag import untag, BrillTagger
...
class BrillTaggerTrainer(object):
    ...
    def train(self, train_sents, max_rules=200, min_score=2, min_acc=None):
        ...
        *min_acc*.
        ...
        #imports
        >>> from nltktc.tbl.template import Template
        >>> from nltktc.tag.brill import Pos, Word
        >>> from nltktc.tag import untag, RegexpTagger, BrillTaggerTrainer
