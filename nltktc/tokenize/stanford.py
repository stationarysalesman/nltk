...
from nltktc.internals import find_jar, config_java, java, _java_options, find_jars_within_path

from nltktc.tokenize.api import TokenizerI
...
class StanfordTokenizer(TokenizerI):
    ...
    >>> from nltktc.tokenize import StanfordTokenizer
...
def setup_module(module):
    ...
    try:
        ...
        raise SkipTest('doctests from nltktc.tokenize.stanford are skipped because the stanford postagger jar doesn\'t exist')
