...
from nltktc.stem import porter
from nltktc.stem.util import suffix_replace
...
class SnowballStemmer(StemmerI):
    ...
    >>> from nltktc.stem import SnowballStemmer
    ...
    >>> from nltktc.stem.snowball import GermanStemmer
...
def demo():
    ...
    import re
    from nltktc.corpus import udhr
