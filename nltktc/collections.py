...
class LazyMap(AbstractLazySequence):
    ...
    equivalent:
        ...
        >>> from nltktc.collections import LazyMap
        >>> function = str
        >>> sequence = [1,2,3]
...
class LazyZip(LazyMap):
    ...
    ``zip``.  In particular, an evaluated LazyZip is equivalent to a zip:
        ...
        >>> from nltktc.collections import LazyZip
...
class LazyEnumerate(LazyZip):
    ...
    equivalent:
        ...
        >>> from nltktc.collections import LazyEnumerate
...
class Trie(defaultdict):
    ...
    def insert(self, string):
        ...
        >>> from nltktc.collections import Trie
        >>> trie = Trie(["ab"])
        >>> trie
