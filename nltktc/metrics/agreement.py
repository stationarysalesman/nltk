...
from nltktc.probability import FreqDist, ConditionalFreqDist
from nltktc.internals import deprecated
from nltktc.compat import python_2_unicode_compatible, iteritems

from nltktc.metrics.distance import binary_distance
...
if __name__ == '__main__':
    ...
    import re
    import optparse
    from nltktc.metrics import distance
